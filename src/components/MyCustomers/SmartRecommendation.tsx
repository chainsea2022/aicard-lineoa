            ...
            <Carousel className="w-full" opts={{ align: "start", dragFree: true }}>
              <CarouselContent className="-ml-1">
                {recommendations.map((contact, index) => (
                  <CarouselItem key={contact.id} className="pl-1 basis-[200px] flex-shrink-0">
                    {/* 如果是第5張名片之後，顯示升級提示 */}
                    {index === 4 && showUpgradePrompt ? (
                      <Card className="shadow-sm bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-300 h-20">
                      ...
                      <Card className="shadow-sm bg-white border border-purple-200 h-20">
                        <CardContent className="p-2">
                          <div className="flex items-center space-x-2 h-full">
                            {/* 頭像 */}
                            <Avatar className="w-8 h-8 flex-shrink-0 border border-purple-300">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center justify-between space-x-1">
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-purple-600 hover:bg-purple-700 text-xs h-5 px-2 flex-shrink-0"
