      ...
      <CardContent className="p-3">
        <div className="flex items-center space-x-3">
          <div className="relative">
            ...
            {customer.isNewAddition && <div className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full border border-white"></div>}
          </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between">
              ...
              {customer.relationshipStatus === 'addedMe' && <Button onClick={e => {
              e.stopPropagation();
              onAddFollower(customer.id);
            }} size="sm" variant="default" className="bg-green-600 hover:bg-green-700 text-xs h-6 px-2">
                  +
                </Button>}
            </div>
          </div>
