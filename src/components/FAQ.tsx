  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "AiCard 採 LINE 授權登入、手機 OTP 驗證 及 Email 驗證 機制，無需設定或重設密碼。\n\n忘記密碼：直接使用相同 LINE 帳號登入，完成手機 OTP 及 Email 驗證即可。\n\n更換手機號碼：請至「設定 > 資料設定」更新手機號碼，並重新進行 OTP 驗證；完成後，系統會自動同步驗證您原有的 Email 資料。\n\n更換 Email：若需變更 Email，請在「設定 > 資料設定」中輸入新郵箱並完成 Double Opt-In（點擊驗證信中的連結）流程。"
        },
        {
