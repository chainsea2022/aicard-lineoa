  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "AiCard 採 LINE 授權登入、手機 OTP 驗證 及 Email 驗證 機制，無需設定密碼。\n\n更換手機號碼：請至「設定 > 資料設定」更新手機號碼，並重新進行 OTP 驗證。\n\n更換 Email：若需變更 Email，請在「設定 > 資料設定」中輸入新郵箱並完成 Double Opt-In（點擊驗證信中的連結）流程。"
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: "Q8. 如何使用類別整理名片？",
          answer: "在名片詳細頁面由AI智能推薦類別選樣，可新增或刪除類別，類別將同步顯示於篩選區，方便快速搜尋與分類。"
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "進入APP的「名片識別」拍照掃描，AI 會自動辨識內容。若相似度 ≥90%，系統會自動匹配更新，並儲存到「我的名片夾」。"
        },
        {
          question: "Q10. 匯入大量名片資料時有什麼限制？",
          answer: "AiCard 網頁版支援 CSV/XLS/XLSX 批次匯入，首次匯入會啟動欄位對應導引，並提供標準格式範本下載，確保資料正確匯入。\n\nAiCard 網頁版：近期上線"
        }
      ]
    },
    {
