    ...
    <div className="fixed inset-0 bg-white z-50 overflow-y-auto">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">下載專屬APP</h1>
            <p className="text-sm text-gray-600">解鎖完整功能體驗</p>
          </div>
        </div>
        <Button
          variant="ghost"
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">AI Card 專屬APP</h2>
        ...
        <div className="space-y-3">
          <h3 className="font-semibold text-gray-900 mb-3">APP 專屬功能</h3>
          ...
          <Card className="border border-blue-100 bg-blue-50/50">
            <CardContent className="p-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 text-sm">進階名片管理</h4>
                  <p className="text-xs text-gray-600 mt-1">無限制標籤分類、批量管理、智能搜尋</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-green-100 bg-green-50/50">
            <CardContent className="p-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 text-sm">AI 智能推薦</h4>
                  <p className="text-xs text-gray-600 mt-1">基於業務場景的精準人脈推薦</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border border-purple-100 bg-purple-50/50">
            <CardContent className="p-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 text-sm">企業級安全</h4>
                  <p className="text-xs text-gray-600 mt-1">資料加密保護、隱私控制設定</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-3 pt-2">
          <Button
            ...
            className="w-full bg-black hover:bg-gray-800 text-white h-12 rounded-xl flex items-center justify-center space-x-3"
          >
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-4 text-center">
          <div className="flex items-center justify-center space-x-2 mb-2">
            ...
            <span className="font-semibold text-gray-900 text-sm">限時優惠</span>
          </div>
