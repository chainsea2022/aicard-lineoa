                        ...
                        <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200 text-center relative">
                              ...
                              <div className="p-3 bg-gray-100 rounded-lg border border-gray-200 text-center relative">
                                <div className="absolute top-1 right-1">
                                  <div className="w-4 h-4 bg-gray-300 rounded-full"></div>
                                </div>
                                <div className="text-lg font-bold text-gray-500">30人</div>
                                <div className="text-sm text-gray-500 mt-1">+60 點</div>
                              </div>
                              <div className="p-3 bg-gray-100 rounded-lg border border-gray-200 text-center relative">
                                <div className="absolute top-1 right-1">
                                  <div className="w-4 h-4 bg-gray-300 rounded-full"></div>
                                </div>
                                <div className="text-lg font-bold text-gray-500">60人</div>
                                <div className="text-sm text-gray-500 mt-1">+100 點</div>
                              </div>
                              <div className="p-3 bg-gray-100 rounded-lg border border-gray-200 text-center relative">
                                <div className="absolute top-1 right-1">
                                  <div className="w-4 h-4 bg-gray-300 rounded-full"></div>
                                </div>
                                <div className="text-lg font-bold text-gray-500">100人</div>
                                <div className="text-sm text-gray-500 mt-1">+150 點</div>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="p-4 border-2 border-gray-200 rounded-lg">
                              ...
                              <div className="space-y-2 text-sm text-gray-600">
                                ...
                                <div className="flex justify-between">
                                  <span>行程管理：新增行程</span>
                                  <span className="text-green-600">1次免費，30點/次</span>
                                </div>
                                <div className="flex justify-between">
                                  <span>行程管理：語音記錄</span>
