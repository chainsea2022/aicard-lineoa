...
import { ArrowLeft, Save, Upload, X, Eye, EyeOff, Info, ChevronDown, ChevronUp, Edit, QrCode, Download, Share2, Calendar as CalendarIcon, Mail, CheckCircle, Camera, Mic, MicOff, Play, Square, Plus, Youtube, Linkedin, MessageCircle, Facebook, Instagram, Award, User } from 'lucide-react';
  ...
  return <div className="absolute inset-0 bg-white z-50 overflow-y-auto">
      ...
      <div className="p-4 bg-gray-50">
        <div className="grid grid-cols-3 gap-3">
          {/* 名片設置 */}
          <Card className="border border-blue-300 bg-blue-50 cursor-pointer">
